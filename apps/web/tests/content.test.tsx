...
describe("public content", () => {
  ...
  it("discloses the full methodology without implying unsupported modes", async () => {
    ...
    for (const topic of ["TR1", "Ranked Solo", "queue 420", "Emerald+", "35-day", "TOP", "JUNGLE", "MIDDLE", "BOTTOM", "UTILITY", "remake", "completed item", "unordered", "multiset", "Wilson", "100", "survivorship", "gold-lead", "correlation", "build rates", "hourly"]) expect(text).toMatch(new RegExp(topic, "i"));
